...
import { Fighter } from "./fighter5"
import { Fighter1 } from "./fighter5"
...
export function GameScene({ player1Position, player2Position, p1, model, animelist }: GameSceneProps) {
  ...
  return (
    <>
      ...
      <Fighter1 position={player2Position} color="#0066ff" name="Player 2" isPlayer1={false} modelPath="/anime/1a.glb" />
